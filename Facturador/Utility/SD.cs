...
namespace Facturador.Utility
{
    public class SD
    {
        ...
        public const string Impuesto = "IVA";

        public const string TipoFactor = "Tasa";

        public const string TasaOCuota = "0.160000";

        public const string TipoRelacion = "I";

        public const string TipoDeComprobante = "I";
    }
}
